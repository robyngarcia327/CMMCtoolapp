...
import { CheckCircle, Sparkles, ChevronDown, ChevronUp, Ticket as TicketIcon, ExternalLink, Share2, Layers, Monitor } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-100">
             ...
             <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                 <h4 className="text-sm font-semibold text-slate-800 uppercase tracking-wider mb-3 flex items-center gap-2">
                    <Share2 size={16} /> Framework Mappings
                 </h4>
                 ...
                 <div className="space-y-3">
                     ...
                     {requirement.mappings.nist_csf && requirement.mappings.nist_csf.length > 0 && (
                        <div className="flex items-start gap-2">
                            <span className="text-xs font-bold text-slate-500 w-16 pt-1">NIST CSF:</span>
                            <div className="flex flex-wrap gap-1.5">
