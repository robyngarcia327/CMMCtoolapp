...
export const REQUIREMENTS_DATA: Requirement[] = [
    // 3.1 ACCESS CONTROL
    {
      id: '3.1.1', framework: 'NIST-CMMC', family: 'AC', title: 'Authorized Access Control',
      ...
      mappings: { nist800_53: ['AC-2', 'AC-3', 'AC-17'] },
      interviewOptions: ['Who approves access requests?', 'How is access removed when a user leaves?']
    },
    {
      id: '3.1.2', framework: 'NIST-CMMC', family: 'AC', title: 'Transaction & Function Control',
    ...
    {
      id: '3.1.5', framework: 'NIST-CMMC', family: 'AC', title: 'Least Privilege',
    ...
    {
      id: '3.1.6', framework: 'NIST-CMMC', family: 'AC', title: 'Non-Privileged Account Use',
      ...
      objectives: [
        ...
        { id: 'b', description: 'users are required to use non-privileged accounts or roles when accessing nonsecurity functions.', status: 'pending' }
      ],
      mappings: { nist800_53: ['AC-6(2)'] }
    },
    {
      id: '3.1.7', framework: 'NIST-CMMC', family: 'AC', title: 'Privileged Functions',
    ...
    {
      id: '3.1.8', framework: 'NIST-CMMC', family: 'AC', title: 'Unsuccessful Logon Attempts',
    ...
    {
      id: '3.1.9', framework: 'NIST-CMMC', family: 'AC', title: 'Privacy & Security Notices',
    ...
    {
      id: '3.1.16', framework: 'NIST-CMMC', family: 'AC', title: 'Wireless Access Authorization',
    ...
    {
      id: '3.1.17', framework: 'NIST-CMMC', family: 'AC', title: 'Wireless Access Protection',
      ...
      mappings: { nist800_53: ['AC-18(1)'] }
    },
    {
      id: '3.1.18', framework: 'NIST-CMMC', family: 'AC', title: 'Mobile Device Connection',
    ...
    {
      id: '3.1.19', framework: 'NIST-CMMC', family: 'AC', title: 'Encrypt CUI on Mobile',
      ...
      mappings: { nist800_53: ['AC-19(5)'] }
    },
    {
      id: '3.1.20', framework: 'NIST-CMMC', family: 'AC', title: 'External Connections',
    ...
    {
      id: '3.1.21', framework: 'NIST-CMMC', family: 'AC', title: 'Portable Storage Use',
      ...
      mappings: { nist800_53: ['AC-20(2)'] }
    },
    {
      id: '3.1.22', framework: 'NIST-CMMC', family: 'AC', title: 'Control Public Information',
    ...
    {
      id: '3.2.3', framework: 'NIST-CMMC', family: 'AT', title: 'Insider Threat Awareness',
    ...
    // 3.3 AUDIT AND ACCOUNTABILITY
    {
      ...
      mappings: { nist800_53: ['AU-2', 'AU-12'] }
    },
    {
    ...
    {
      id: '3.3.3', framework: 'NIST-CMMC', family: 'AU', title: 'Event Review',
    ...
    {
      id: '3.3.4', framework: 'NIST-CMMC', family: 'AU', title: 'Audit Failure Alerting',
    ...
    {
      id: '3.3.5', framework: 'NIST-CMMC', family: 'AU', title: 'Audit Correlation',
      ...
      mappings: { nist800_53: ['AU-6(3)'] }
    },
    {
      id: '3.3.6', framework: 'NIST-CMMC', family: 'AU', title: 'Reduction & Reporting',
    ...
    {
      id: '3.3.7', framework: 'NIST-CMMC', family: 'AU', title: 'Authoritative Time Source',
    ...
    {
      id: '3.3.8', framework: 'NIST-CMMC', family: 'AU', title: 'Audit Protection',
    ...
    {
      id: '3.3.9', framework: 'NIST-CMMC', family: 'AU', title: 'Audit Management',
    ...
    {
      id: '3.4.2', framework: 'NIST-CMMC', family: 'CM', title: 'Security Configuration Enforcement',
    ...
    {
      id: '3.4.3', framework: 'NIST-CMMC', family: 'CM', title: 'System Change Management',
    ...
    {
      id: '3.4.4', framework: 'NIST-CMMC', family: 'CM', title: 'Security Impact Analysis',
    ...
    {
      id: '3.4.5', framework: 'NIST-CMMC', family: 'CM', title: 'Access Restrictions for Change',
    ...
    {
      id: '3.4.6', framework: 'NIST-CMMC', family: 'CM', title: 'Least Functionality',
    ...
    {
      id: '3.4.7', framework: 'NIST-CMMC', family: 'CM', title: 'Nonessential Functionality',
    ...
    {
      id: '3.4.8', framework: 'NIST-CMMC', family: 'CM', title: 'Application Execution Policy',
      ...
      mappings: { nist800_53: ['CM-7(4)'] }
    },
    {
      id: '3.4.9', framework: 'NIST-CMMC', family: 'CM', title: 'User-Installed Software',
    ...
    {
      id: '3.5.1', framework: 'NIST-CMMC', family: 'IA', title: 'Identification',
      description: 'Identify system users, processes acting on behalf of users, and devices.',
      cmmcLevel: 1, sprsWeight: 3,
      objectives: [
    ...
    {
      id: '3.5.2', framework: 'NIST-CMMC', family: 'IA', title: 'Authentication',
    ...
    {
      id: '3.5.3', framework: 'NIST-CMMC', family: 'IA', title: 'Multifactor Authentication',
      ...
      mappings: { nist800_53: ['IA-2(1)', 'IA-2(2)', 'IA-2(3)'] }
    },
    {
      id: '3.5.4', framework: 'NIST-CMMC', family: 'IA', title: 'Replay-Resistant Authentication',
      ...
      mappings: { nist800_53: ['IA-2(8)'] }
    },
    {
      id: '3.5.5', framework: 'NIST-CMMC', family: 'IA', title: 'Identifier Reuse',
    ...
    {
      id: '3.5.6', framework: 'NIST-CMMC', family: 'IA', title: 'Identifier Handling',
    ...
    {
      id: '3.5.7', framework: 'NIST-CMMC', family: 'IA', title: 'Password Complexity',
      ...
      mappings: { nist800_53: ['IA-5(1)'] }
    },
    {
      id: '3.5.8', framework: 'NIST-CMMC', family: 'IA', title: 'Password Reuse',
    ...
    {
      id: '3.5.9', framework: 'NIST-CMMC', family: 'IA', title: 'Temporary Passwords',
    ...
    {
      id: '3.5.10', framework: 'NIST-CMMC', family: 'IA', title: 'Cryptographically-Protected Passwords',
    ...
    {
      id: '3.5.11', framework: 'NIST-CMMC', family: 'IA', title: 'Obscure Feedback',
    ...
    {
      id: '3.6.1', framework: 'NIST-CMMC', family: 'IR', title: 'Incident Handling',
    ...
    {
      id: '3.6.2', framework: 'NIST-CMMC', family: 'IR', title: 'Incident Reporting',
    ...
    {
      id: '3.6.3', framework: 'NIST-CMMC', family: 'IR', title: 'Incident Response Testing',
    ...
    {
      id: '3.7.4', framework: 'NIST-CMMC', family: 'MA', title: 'Media Inspection',
      ...
      mappings: { nist800_53: ['MA-3(3)'] }
    },
    {
      id: '3.7.5', framework: 'NIST-CMMC', family: 'MA', title: 'Nonlocal Maintenance',
    ...
    {
      id: '3.7.6', framework: 'NIST-CMMC', family: 'MA', title: 'Maintenance Personnel',
    ...
    {
      id: '3.8.4', framework: 'NIST-CMMC', family: 'MP', title: 'Media Markings',
    ...
    {
      id: '3.8.5', framework: 'NIST-CMMC', family: 'MP', title: 'Media Accountability',
    ...
    {
      id: '3.8.6', framework: 'NIST-CMMC', family: 'MP', title: 'Portable Storage Encryption',
      ...
      mappings: { nist800_53: ['MP-5(4)'] }
    },
    {
      id: '3.8.7', framework: 'NIST-CMMC', family: 'MP', title: 'Removeable Media',
    ...
    {
      id: '3.8.8', framework: 'NIST-CMMC', family: 'MP', title: 'Shared Media',
    ...
    {
      id: '3.8.9', framework: 'NIST-CMMC', family: 'MP', title: 'Protect Backups',
    ...
    {
      id: '3.9.2', framework: 'NIST-CMMC', family: 'PS', title: 'Personnel Actions',
    ...
    {
      id: '3.10.3', framework: 'NIST-CMMC', family: 'PE', title: 'Escort Visitors',
    ...
    {
      id: '3.10.4', framework: 'NIST-CMMC', family: 'PE', title: 'Physical Access Logs',
    ...
    {
      id: '3.10.5', framework: 'NIST-CMMC', family: 'PE', title: 'Manage Physical Access',
    ...
    {
      id: '3.13.1', framework: 'NIST-CMMC', family: 'SC', title: 'Boundary Protection',
    ...
    {
      id: '3.13.2', framework: 'NIST-CMMC', family: 'SC', title: 'Security Engineering',
    ...
    {
      id: '3.13.3', framework: 'NIST-CMMC', family: 'SC', title: 'Role Separation',
      ...
      mappings: { nist800_53: ['SC-2'] }
    },
    {
      id: '3.13.4', framework: 'NIST-CMMC', family: 'SC', title: 'Shared Resource Control',
    ...
    {
      id: '3.13.5', framework: 'NIST-CMMC', family: 'SC', title: 'Public-Access System Separation',
      ...
      mappings: { nist800_53: ['SC-7(1)'] }
    },
    {
      id: '3.13.6', framework: 'NIST-CMMC', family: 'SC', title: 'Network Communication by Exception',
    ...
    {
      id: '3.13.8', framework: 'NIST-CMMC', family: 'SC', title: 'Data in Transit',
    ...
    {
      id: '3.13.9', framework: 'NIST-CMMC', family: 'SC', title: 'Connections Termination',
    ...
    {
      id: '3.13.10', framework: 'NIST-CMMC', family: 'SC', title: 'Key Management',
    ...
    {
      id: '3.13.12', framework: 'NIST-CMMC', family: 'SC', title: 'Collaborative Device Control',
    ...
    {
      id: '3.13.13', framework: 'NIST-CMMC', family: 'SC', title: 'Mobile Code',
    ...
    {
      id: '3.13.14', framework: 'NIST-CMMC', family: 'SC', title: 'Voice over Internet Protocol',
    ...
    {
      id: '3.13.15', framework: 'NIST-CMMC', family: 'SC', title: 'Communications Authenticity',
    ...
    {
      id: '3.13.16', framework: 'NIST-CMMC', family: 'SC', title: 'Data at Rest',
    ...
    {
      id: '3.14.1', framework: 'NIST-CMMC', family: 'SI', title: 'Flaw Remediation',
    ...
    {
      id: '3.14.2', framework: 'NIST-CMMC', family: 'SI', title: 'Malicious Code Protection',
    ...
    {
      id: '3.14.3', framework: 'NIST-CMMC', family: 'SI', title: 'Security Alerts & Advisories',
    ...
    {
      id: '3.14.4', framework: 'NIST-CMMC', family: 'SI', title: 'Update Malicious Code Protection',
    ...
    {
      id: '3.14.5', framework: 'NIST-CMMC', family: 'SI', title: 'System & File Scanning',
      ...
      objectives: [
        ...
        { id: 'c', description: 'real-time malicious code scans of files from external sources as files are downloaded, opened, or executed are performed.', status: 'pending' }
      ],
      mappings: { nist800_53: ['SI-3'] }
    },
    {
...
export const TRAINING_MODULES: (TrainingModule | SimulationModule)[] = [
  ...
  {
    id: 'sim-1', familyId: 'PH6', title: 'Executive Ransomware Response',
    description: 'High-stakes tabletop exercise for leadership decision-making.',
    content: 'Simulator content loading...',
    durationMinutes: 60, difficulty: 'Advanced',
    isSimulation: true,
    executiveFocus: 'Crisis Communication & Disclosure',
    injects: [
        { id: 'inj1', title: 'The Discovery', scenario: 'The IT Manager reports that files on the CUI server are encrypted.', regulatoryHint: 'Reference IR 3.6.1: Are your handling procedures operational?' },
        { id: 'inj2', title: 'The Ransom Note', scenario: 'A note demands 50 BTC for the decryption key.', regulatoryHint: 'Reference IR 3.6.2: Who are the external authorities to notify?' }
    ]
  }
];
